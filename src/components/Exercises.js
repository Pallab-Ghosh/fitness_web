...
export const Exercises = () => {
 //use the context of exercise_data_details
  ...
  const last_exercise_no=currentPage*exercisePerPage;
  const first_exercise_no=last_exercise_no-exercisePerPage

  const currentexercises=exercises.slice(first_exercise_no,last_exercise_no)
